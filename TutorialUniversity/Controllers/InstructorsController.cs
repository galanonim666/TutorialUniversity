...
using TutorialUniversity.Models.SchoolViewModels;
        ...
        private void UpdateInstructorCourses(string[] selectedCourses, Instructor instructorToUpdate)
        {
            ...
            foreach (var course in _context.Courses)
            {
                ...
                else
                {
                    if (instructorCourses.Contains(course.CourseID))
                    {
                        //var courseAssignmentsToRemove = instructorToUpdate.CourseAssignments.Single(ca => ca.CourseID == course.CourseID);
                        //instructorToUpdate.CourseAssignments.Remove(courseAssignmentsToRemove);
